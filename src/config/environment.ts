...
export const env = {
  ...
  SEABAY_APP_KEY: process.env.SEABAY_APP_KEY,
  SEABAY_APP_SECRET: process.env.SEABAY_APP_SECRET,
  SEARATES_PLATFORM_ID: process.env.SEARATES_PLATFORM_ID,
  SEARATES_API_KEY: process.env.SEARATES_API_KEY,
  SEARATES_LOGIN: process.env.SEARATES_LOGIN,
  SEARATES_PASSWORD: process.env.SEARATES_PASSWORD,
